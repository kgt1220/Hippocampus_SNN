    ...
    def solve(self, inputs, t, ER, N, En_win, Re_win):
        ...
        for n in range(self.N_types):
            ...
            if n == 0:
                ...
                # Activation of DG and mossy fiber regardless of phases
                if self.types == 'CA3' or self.types == 'CA3i' or self.types == 'DGH' or self.types == 'DGM' or self.types == 'DGB' or self.types == 'DG':
                    inputs_ph = inputs[n]
                ...
                if self.types == 'DGM' or self.types == 'DGB' or self.types == 'DG':
                    ...
                    inputs_ph = inputs[n]
                    if len(set(np.where(self.q[n]!=0)[0]).intersection(set(np.where(inputs[n]!=0)[0]))) !=0:
                        self.WTS.append([n, np.where(inputs[n] !=0)[0], t])
                    ...
                    if ER:
                        ...
                        inputs_ph = inputs[n]
                    # Suppression of direct perforant path
